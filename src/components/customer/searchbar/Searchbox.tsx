...
export default function SearchBox({ onSearch, defaultValues }: SearchBoxProps) {
  ...
  return (
    <div className="flex items-center justify-center px-4 md:px-0 relative z-10">
      ...
      `}</style>
      <div className="bg-white shadow-lg searchbox-container rounded-md">
        <form
        ...
        >
                ...
                <div className="absolute left-0 top-full w-full">
                  <CalendarPopup
                    ...
                    disabledDay={(date) =>
                      isPast(date) ||
                      (checkIn
                        ? isBefore(date, parseLocalYmd(checkIn)) ||
                          isSameDay(date, parseLocalYmd(checkIn))
                        : false)
                    }
                  />
                </div>
          ...
          {/* ห้อง / คน */}
          <div
            className="flex flex-col w-full md:w-[240px] relative"
          ...
          >
            ...
            <button
              id="roomguest"
              type="button"
              className="w-full h-12 border border-gray-300 rounded-lg px-3 pr-8 text-sm text-left bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400 appearance-none cursor-pointer flex items-center"
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      onClick={() => setRoom((r) => Math.max(1, r - 1))}
                      disabled={room <= 1}
          ...
          <div className="flex flex-col w-full md:w-[144px]">
            ...
            <button
              ...
              className={`w-full h-12 border rounded-lg text-sm font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-orange-400 cursor-pointer ${
                validationError
