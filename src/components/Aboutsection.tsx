...
export default function Aboutsection() {
  ...
  // When screen <= 600, treat as mobile
  useEffect(() => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        overflow: "hidden",
                        background: "#fff",
                        boxShadow: "0 2px 8px 0 rgba(20,36,46,0.06)",
                        opacity: 1,
                        zIndex: 1,
                        marginLeft: k === 0 ? 0 : "0px",
                        marginRight: k === 2 ? 0 : "0px",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                    ...
                    >
                      ...
                      />
                      {/* Left Button - only on center image */}
                      {k === 1 && (
                        <button
                          ...
                          style={{
                            ...
                            border: "2px solidrgb(204, 204, 204)",
                            borderRadius: "50%",
                            width: 32,
                            height: 32,
                            minWidth: 32,
